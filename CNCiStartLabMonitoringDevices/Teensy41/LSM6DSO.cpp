...
bool LSM6DSO::check_who_am_i(){
    ...
    if (this->_received_data[0] == this->_who_am_i_val){
        ...
        return false;
            ...
            Serial.print("[INFO][LSM6DSO] LSM6DSO::check_who_am_i() - WHO_AM_I_VAL: "); Serial.println(this->_who_am_i_val);
        #endif
        return true;
    }
}
...
void LSM6DSO::set_mode_1(uint16_t acc_fifo_wtm_val){
    ...
    this->set_CTRL4_C(LSM6DSO::SLEEP_G_ENABLED, LSM6DSO::INT2_on_INT1_DISABLED, LSM6DSO::DRDY_MASK_DISABLED, LSM6DSO::I2C_DISABLE_DISABLED, LSM6DSO::LPF1_SEL_G_DISABLED);
