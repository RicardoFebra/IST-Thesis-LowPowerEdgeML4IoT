 ...
 * 
 * @param raw_data_sample_nr {int} Number of samples of the raw data
 * @param windows_nr {int} Number of windows to be used in the analysis
 * @param raw_data {int*} Pointer to the array of raw data
 */
