/**
 * @file DataHandlerAcc.h
 * @brief This file contains the declaration of the variables and functions used in the data handling of the accelerometer data.
 * 
 */

//------------------------------------------------------------------------------------------
//                              Define the desired sensors and tasks
/*------ACC------*/
#define MMA8451_acc
/*------Analysis------*/
...
const uint16_t acc_window_sample_nr = 512; //This value MUST ALWAYS be a power of 2
const uint16_t acc_windows_nr = 2; //This value can be changed to increase the number of windows to make an average of

const uint32_t acc_sample_nr = acc_window_sample_nr*acc_windows_nr;
