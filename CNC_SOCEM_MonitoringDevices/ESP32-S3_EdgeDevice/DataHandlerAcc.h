...
const uint16_t acc_windows_nr = 4; //This value can be changed to increase the number of windows to make an average of
...
const int acc_sampling_frequency = 6667; //This value can be changed to the desired sampling frequency
const uint16_t acc_fifo_wtm_val = 500;
const uint8_t wtm_interrupt_pin = 17;
