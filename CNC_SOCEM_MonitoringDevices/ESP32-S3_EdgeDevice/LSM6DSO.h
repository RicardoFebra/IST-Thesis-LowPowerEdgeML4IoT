...
class LSM6DSO{
    ...
    public:
        ...
        void set_CTRL2_G(byte ODR_G, byte FS_G, byte FS_125);
        ...
        void set_CTRL6_C(byte TRIG_EN, byte LVL1_EN, byte LVL2_EN, byte XL_HM_MODE, byte USR_OFF_W, byte FTYPE_2, byte FTYPE_1, byte FTYPE_0);
        ...
        void set_WAKE_UP_SRC(byte SLEEP_CHANGE_IA, byte FF_IA, byte SLEEP_STATE, byte WU_IA, byte X_WU, byte Y_WU, byte Z_WU);
        void get_STATUS_REG();
        bool check_XLDA();
        ...
        typedef enum{
            SLEEP_CHANGE_IA_DISABLED = 0x00,
            SLEEP_CHANGE_IA_ENABLED = 0x01,
        }lsm6dso_sleep_change_ia_t;
        ...
        typedef enum{
            SLEEP_STATE_DISABLED = 0x00,
            SLEEP_STATE_ENABLED = 0x01,
        }lsm6dso_sleep_state_t;
        ...
        typedef enum{
            TRIG_EN_DISABLED = 0x00,
            TRIG_EN_ENABLED = 0x01,
        }lsm6dso_trig_en_t;

        typedef enum{
            LVL1_EN_DISABLED = 0x00,
            LVL1_EN_ENABLED = 0x01,
        }lsm6dso_lvl1_en_t;

        typedef enum{
            LVL2_EN_DISABLED = 0x00,
            LVL2_EN_ENABLED = 0x01,
        }lsm6dso_lvl2_en_t;

        typedef enum{
            XL_HM_MODE_ENABLED = 0x00,
            XL_HM_MODE_DISABLED = 0x01,
        }lsm6dso_xl_hm_mode_t;

        typedef enum{
            USR_OFF_W_DISABLED = 0x00,
            USR_OFF_W_ENABLED = 0x01,
        }lsm6dso_usr_off_w_t;

        typedef enum{
            FTYPE_2_DISABLED = 0x00,
            FTYPE_2_ENABLED = 0x01,
        }lsm6dso_ftype_2_t;

        typedef enum{
            FTYPE_1_DISABLED = 0x00,
            FTYPE_1_ENABLED = 0x01,
        }lsm6dso_ftype_1_t;

        typedef enum{
            FTYPE_0_DISABLED = 0x00,
            FTYPE_0_ENABLED = 0x01,
        }lsm6dso_ftype_0_t;
